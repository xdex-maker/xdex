...
contract('Migrator', ([alice, bob, dev, minter]) => {
    beforeEach(async () => {
        ...
        this.chef = await MasterChef.new(this.xdex.address, this.migrator.address, '1000', '0', '100000', { from: alice });
        await this.migrator.setChef(this.chef.address, { from: alice });
